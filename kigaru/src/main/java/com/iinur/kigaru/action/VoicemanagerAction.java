...
public class VoicemanagerAction extends ActionSupport implements CookiesAware, ServletResponseAware{
	
	private static final Logger log = LoggerFactory.getLogger(VoicemanagerAction.class);
	...
	public String execute(){
		...
		this.voices = vmodel.get(point, VOICES_LIMIT);
		return SUCCESS;
	}
